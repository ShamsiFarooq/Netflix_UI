...
mixin _$HomeState {
  ...
  List<HotAndNewData> get tenseDramasMovieList =>
      throw _privateConstructorUsedError;
  List<HotAndNewData> get southIndianMoviesList =>
      throw _privateConstructorUsedError;
...
abstract class $HomeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      List<HotAndNewData> southIndianMoviesList,
...
class _$HomeStateCopyWithImpl<$Res, $Val extends HomeState>
  ...
  $Res call({
    ...
    Object? southIndianMoviesList = null,
    ...
    return _then(_value.copyWith(
      ...
      tenseDramasMovieList: null == tenseDramasMovieList
          ...
          : tenseDramasMovieList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
      southIndianMoviesList: null == southIndianMoviesList
          ? _value.southIndianMoviesList
          : southIndianMoviesList // ignore: cast_nullable_to_non_nullable
              as List<HotAndNewData>,
...
class _$_Initial implements _Initial {
  const _$_Initial(
      ...
      required final List<HotAndNewData> southIndianMoviesList,
      ...
      : _pastYearMovieList = pastYearMovieList,
        ...
        _southIndianMoviesList = southIndianMoviesList,
  ...
  final List<HotAndNewData> _southIndianMoviesList;
  @override
  List<HotAndNewData> get southIndianMoviesList {
    if (_southIndianMoviesList is EqualUnmodifiableListView)
      return _southIndianMoviesList;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_southIndianMoviesList);
  }
  ...
  @override
  String toString() {
    return 'HomeState(stateId: $stateId, pastYearMovieList: $pastYearMovieList, trendingMovieList: $trendingMovieList, tenseDramasMovieList: $tenseDramasMovieList, southIndianMoviesList: $southIndianMoviesList, trendingTvList: $trendingTvList, isLoading: $isLoading, isError: $isError)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._southIndianMoviesList, _southIndianMoviesList) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_southIndianMoviesList),
